...
void initScene () {
	...
	//scenePtr->setBackgroundColor (glm::vec3 (1.0f, 1.0f, 1.0f));
	scenePtr->setBackgroundColor (glm::vec3 (0.3f, 0.3f, 0.3f));
	...
	scenePtr->add (std::make_shared<LightSource> (normalize (glm::vec3(0.f, -1.f, -1.f)), glm::vec3(1.f, 1.f, 1.f), 0.5f)); // Key light
	scenePtr->add (std::make_shared<LightSource> (normalize (glm::vec3(-2.f, -0.5f, 0.f)), glm::vec3(1.f, 1.f, 1.f), 0.25f)); // Fill light
	scenePtr->add (std::make_shared<LightSource> (normalize (glm::vec3(2.f, -0.5f, 0.f)), glm::vec3(1.0f, 1.f, 1.f), 0.25f)); // Rim light
